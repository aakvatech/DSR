...
from dsr.custom_api import make_sales_invoice,get_cost_center_from_fuel_station,get_item_from_fuel_item,get_company_from_fuel_station,get_pump_warehouse,get_mera_wholesale_rate,get_oil_company_from_fuel_station,get_linked_docs_info,cancle_linked_docs,delete_linked_docs
